...
int main() {
    ...
    Table table;
    table.addColumn("ID").addColumn("Name").addColumn("Status").addColumn(
        "Progress");
    ...
    ProgressBar progress(100, "Processing items", console);
    progress.start();
    ...
    Text markup =
        Text::fromMarkup("This is [bold]bold[/bold], [red]red[/red], and "
